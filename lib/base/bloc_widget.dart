...
class BlocWidget<E, S, B extends Bloc<E, S>> extends StatefulWidget {
  ...
  @override
  _BlocWidgetState<E, S, B> createState() =>
      _BlocWidgetState<E, S, B>(BlocFactory.create<B>(data));
}

class _BlocWidgetState<E, S, B extends Bloc<E, S>>
    extends State<BlocWidget<E, S, B>> {
